    ...
    <section className="py-16 md:py-24 bg-background">
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center mb-12">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-center text-foreground tracking-tight">
            What our users say
          </h2>
          <p className="text-lg text-muted-foreground text-center max-w-xl mt-4">
